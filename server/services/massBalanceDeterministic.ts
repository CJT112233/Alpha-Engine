...
function buildSummary(calc: BiogasCalcResult): Record<string, { value: string; unit: string }> {
  return {
    ...
    rngProduction: { value: r(calc.rngMmbtuPerDay, 1), unit: "MMBTU/day" },
    rngProductionAnnual: { value: r(calc.rngMmbtuPerDay * 365), unit: "MMBTU/yr" },
    rngFlowSCFM: { value: r(calc.rngScfm, 1), unit: "SCFM" },
...
function generateTypeDMassBalance(upif: any): DeterministicMBResult {
  ...
  const summary: Record<string, { value: string; unit: string }> = {
    ...
    rngProduction: { value: r(rngMmbtuPerDay, 1), unit: "MMBTU/day" },
    rngProductionAnnual: { value: r(rngMmbtuPerDay * 365), unit: "MMBTU/yr" },
    rngFlowSCFM: { value: r(rngScfm, 1), unit: "SCFM" },
