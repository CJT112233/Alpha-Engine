...
export const OUTPUT_CRITERIA_LIBRARY: OutputProfile[] = [
  {
    ...
    criteria: {
      rngAvgFlowScfm: {
        ...
        unit: "SCFM",
        confidence: "low",
        provenance: "Calculated from biogas input flow, CH\u2084 content, and upgrading recovery \u2014 project-specific",
        group: "rng_flow",
        displayName: "Average Flow",
        sortOrder: 1,
      },
      rngMaxFlowScfm: {
        value: "TBD",
        unit: "SCFM",
        confidence: "low",
        provenance: "Based on max biogas input flow through upgrading system \u2014 project-specific",
        group: "rng_flow",
      ...
      rngMinFlowScfm: {
        ...
        unit: "SCFM",
        confidence: "low",
        provenance: "Based on min biogas input flow through upgrading system \u2014 project-specific",
        group: "rng_flow",
        displayName: "Min Flow",
        sortOrder: 3,
      },
      rngPressurePsig: {
        value: "200-800",
        unit: "psig",
        confidence: "medium",
        provenance: "Pipeline injection pressure; varies by utility interconnection requirements",
        group: "rng_flow",
      ...
      rngCO2: {
        ...
        unit: "%",
        confidence: "high",
        provenance: "Standard pipeline limit for CO\u2082",
        group: "rng_composition",
      ...
      rngH2S: {
        ...
        unit: "ppm",
        confidence: "high",
        provenance: "Common pipeline limit; \u2264 0.25 grain/100 scf",
        group: "rng_composition",
      ...
      rngBtuPerScf: {
        ...
        unit: "Btu/SCF",
        confidence: "high",
        provenance: "Standard pipeline heating value range (NAESB/tariff requirements, HHV basis)",
        group: "rng_energy",
        displayName: "Heating Value",
        sortOrder: 10,
      },
      rngMmbtuPerDay: {
        value: "TBD",
        unit: "MMBtu/Day",
        confidence: "low",
        provenance: "Calculated from RNG average flow \u00d7 heating value \u2014 project-specific",
        group: "rng_energy",
...
export function enrichOutputSpecs(
  ...
  const criterionKeyMap: Record<string, string> = {
    "rng average flow": "rngAvgFlowScfm",
    "rng avg flow": "rngAvgFlowScfm",
    "rng average flow scfm": "rngAvgFlowScfm",
    "rng flow": "rngAvgFlowScfm",
    "rng max flow": "rngMaxFlowScfm",
    "rng maximum flow": "rngMaxFlowScfm",
    "rng peak flow": "rngMaxFlowScfm",
    "rng min flow": "rngMinFlowScfm",
    "rng minimum flow": "rngMinFlowScfm",
    "rng pressure": "rngPressurePsig",
    "rng pressure psig": "rngPressurePsig",
    "rng injection pressure": "rngPressurePsig",
    "rng ch4": "rngCH4",
    "rng methane": "rngCH4",
    "rng ch4%": "rngCH4",
    "rng co2": "rngCO2",
    "rng carbon dioxide": "rngCO2",
    "rng h2s": "rngH2S",
    "rng hydrogen sulfide": "rngH2S",
    "rng h2s ppm": "rngH2S",
    "rng n2": "rngN2",
    "rng nitrogen": "rngN2",
    "rng o2": "rngO2",
    "rng oxygen": "rngO2",
    "rng btu/scf": "rngBtuPerScf",
    "rng heating value": "rngBtuPerScf",
    "rng btu": "rngBtuPerScf",
    "rng mmbtu/day": "rngMmbtuPerDay",
    "rng mmbtu per day": "rngMmbtuPerDay",
    "rng energy": "rngMmbtuPerDay",
    "rng energy content": "rngMmbtuPerDay",
