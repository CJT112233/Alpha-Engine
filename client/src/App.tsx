...
import DocsValidationConfig from "@/pages/docs-validation-config";
...
function Router() {
  return (
    <Switch>
      ...
      <Route path="/docs/validation-config" component={DocsValidationConfig} />
      ...
      <Route path="/scenarios/:scenarioId/opex" component={OpexPage} />
